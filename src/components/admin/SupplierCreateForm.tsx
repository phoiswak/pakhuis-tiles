...
export function SupplierCreateForm() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-3 border border-stone-line bg-white p-5">
      <h2 className="font-display text-xl text-ink">New supplier</h2>
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <div>
          ...
          <input id="contactPerson" name="contactPerson" className="field" />
        </div>
        <div>
      ...
      {status === "success" && <p className="text-sm text-moss">Supplier created.</p>}
